  ...
  return (
    <div className="visualiser">
      ...
      <div className="input-area">
        ...
        >
          {ChromaticScale.map((scale, index) => (
            <option key={index} className="select-option-root" value={scale[0]}>
              {scale[1]}
            </option>
          ))}
        </select>
        ...
        >
          {scaleNames.map((scale, index) => (
            <option key={index} className="select-option-scale" value={index}>
              {scale}
            </option>
          ))}
        </select>
      ...
      <div className="fretboard-box">
        <label id="fretboard-box-label" htmlFor="fretboard-box">
          Hide Fretboard Box?
        </label>
        <input
          id="fretboard-box"
          type="checkbox"
          value="Test"
          onClick={setShowHideBox}
        />
      </div>
      <h3 className="scale-arpeggio-type">
        {ChromaticScale[scaleType[0]][1]} {scaleNames[scaleType[1]]}
      </h3>
      <Fretboard
      ...
      <div className="SaveAsImage">
        <button
          ...
          onClick={() =>
            exportAsImage(document.getElementById(fretboardType), "Scale")
          }
        >
          Save as Image
        </button>
